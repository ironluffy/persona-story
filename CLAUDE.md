...
- **Eye-of-the-Moon/persona** — CLI 코드 레포 (코드 변경, 코드 버그는 여기)
- **Eye-of-the-Moon/persona-story** — 이 레포 (설계, 논의, 기록)

## 이슈 라우팅 가이드

- 코드 버그, 코드 변경 PR → `Eye-of-the-Moon/persona`
- 설계 논의, 발견 기록, 백로그, 독푸딩 → `Eye-of-the-Moon/persona-story` (여기)
